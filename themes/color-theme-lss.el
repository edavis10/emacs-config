;; Little Stream Software Colour Theme for Emacs.
;;
;; Defines a colour scheme based on the Hober theme but with a few tweaks.
...
;;
;; And then (color-theme-lss) to activate it.
;;
...
;;;###autoload
(defun color-theme-lss (&optional preview)
